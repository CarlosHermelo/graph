...
def retrieve_general_info(state: State):
    ...
    print("-----------------##### paso por retrieve general #######-----------------------")
...
te paso este mensaje que tiene una pregunta y un contexo. Debes responder en base a la pregunta usando el contexto unicamente. No debe obtener informacion de los docuemntos que no sea del contexto
...
Con los fragmentos que utilices para la respuesta toma de su metadata el codigo que dice en su Fragmento de la resolución, por ejemplo de aquie Fragmento de la resolución: RESOL-2024-2568-INSSJP-DE#INSSJP su codigo es  RESOL-2024-2568-INSSJP-DE#INSSJP.
Y ponelo como referencia 
La pregunta es: 
...
if __name__ == "__main__":
    ...
    pregunta = "¿ Que resoluciones tratan chequeate en casa  ?"
